...
<ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown">
        ...
        ?>
            <a href="<?php echo base_url().$this->uri->segment(1); ?>/pesanmasuk"
    ...
    <li class="nav-item">
        <a class="nav-link"
            href="<?php echo base_url().$this->uri->segment(1); ?>/edit_manajemenuser/<?php echo $this->session->username; ?>"><i
                class="nav-icon fas fa-user-edit"></i></a>
    </li>
    <li class="nav-item">
        <a class="nav-link" data-widget="control-sidebar" data-slide="true" target='_BLANK'
            href="<?php echo base_url(); ?>"><i class="fas fa-cog"></i></a>
    </li>
</ul>