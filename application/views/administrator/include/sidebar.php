...
<a href="<?php echo base_url().$this->uri->segment(1); ?>" class="brand-link navbar-light">
    <img src="<?php echo base_url(); ?>/asset/logo/admin.png" alt="Admin Logo"
...
<div class="sidebar">
    ...
    <!-- Sidebar Menu -->
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat menu-open nav-legacy nav-compact"
            data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-header">MAIN MENU</li>
            <li class="nav-item"><a class="nav-link" href="<?php echo base_url().$this->uri->segment(1); ?>/home"><i
          ...
          ?>
            <li class="nav-item has-treeview module-nicepage">
                <a href="#" class="nav-link">
                    ...
                    <p>Modul Nicepage <i class="right fas fa-angle-left"></i></p>
                </a>
                <ul class="nav nav-treeview">
                    <?php       
              ...
              if($cek==1 OR $this->session->level=='admin'){
                echo "<li class='nav-item nicepage-portfolio'><a class='nav-link' href='".base_url().$this->uri->segment(1)."/nicepage-portfolio'><i class='far fa-circle nav-icon text-success'></i> <p>Gallery</p></a></li>";
              }     
              //mod nicepage
            ...
            <li class="nav-item"><a class="nav-link" href="<?php echo base_url().$this->uri->segment(1); ?>/logout"><i
