    ...
    <div class="card-body">
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                ...
                <input placeholder="Nama Project" id="nama-project" type="text" class="form-control" name="nama_project"
                    required="required">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <textarea placeholder="Deskripsi" name="deskripsi" id="deskripsi" rows="5"
