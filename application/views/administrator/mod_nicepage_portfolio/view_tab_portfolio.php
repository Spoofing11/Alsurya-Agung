                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        if(file_exists($image_file) && !empty($portfolio['image'])) {
                            ?>
                            <img src="<?php echo base_url()."asset/img_nicepage/portfolio/".$portfolio['image'];?>"
                                style="width:100%">
                            <?php
                        } else {
                            ?>
                    ...
                    ?>
                        ...
                        <td>
                            ...
                            <button data-nama="<?php echo $portfolio['nama'] ;?>" type="button"
                                class="nicepage-btn-portfolio-delete btn btn-xs btn-danger" name="delete_portfolio">
...
$(function() {
    ...
    $('.nicepage-btn-portfolio-edit').on('click', function(e) {
        ...
        // form
        $('#nicepage-portfolio #content-portfolio-form #nicepage-portfolio-form #id').val($(this).data(
            'id'));
        $('#nicepage-portfolio #content-portfolio-form #nicepage-portfolio-form #nama-project').val($(
            this).data('namaproject'));
        $('#nicepage-portfolio #content-portfolio-form #nicepage-portfolio-form #nama-client').val($(
            this).data('namaclient'));
        $('#nicepage-portfolio #content-portfolio-form #nicepage-portfolio-form #deskripsi').val($(this)
            .data('deskripsi'));
        $('#nicepage-portfolio #content-portfolio-form #nicepage-portfolio-form #url').val($(this).data(
            'url'));
        ...
        if ($(this).data('image')) {
            ...
            $('#nicepage-portfolio #content-portfolio-form #nicepage-portfolio-form #file-image-upload')
                .removeAttr('required');
        }
    ...
    var nicePagePortfolioClearForm = function() {
        ...
        $('#nicepage-portfolio #content-portfolio-form #nicepage-portfolio-form #file-image').html('');
        $('#nicepage-portfolio #content-portfolio-form #nicepage-portfolio-form #file-image-upload').attr(
            'required', '');
    }
