                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        if(file_exists($photo_file) && !empty($team['photo'])) {
                            ?>
                            <img src="<?php echo base_url()."asset/img_nicepage/team/".$team['photo'];?>"
                                style="width:100%">
                            <?php
                        } else {
                            ?>
                    ...
                    ?>
                        ...
                        <td>
                            <button type="button" class="nicepage-btn-team-edit btn btn-xs btn-success"
                                data-id="<?php echo $team['id_team'] ;?>" data-nama="<?php echo $team['nama'] ;?>"
                            ...
                            <button data-nama="<?php echo $team['nama'] ;?>" type="button"
                                class="nicepage-btn-team-delete btn btn-xs btn-danger" name="delete_team">
...
$(function() {
    ...
    $('.nicepage-btn-team-edit').on('click', function(e) {
        ...
        $('#nicepage-team #content-team-form #nicepage-team-form #jabatan').val($(this).data(
        'jabatan'));
        $('#nicepage-team #content-team-form #nicepage-team-form #socmed-fb').val($(this).data(
            'socmedfb'));
        $('#nicepage-team #content-team-form #nicepage-team-form #socmed-twitter').val($(this).data(
            'socmedtwitter'));
        $('#nicepage-team #content-team-form #nicepage-team-form #socmed-ig').val($(this).data(
            'socmedig'));
        $('#nicepage-team #content-team-form #nicepage-team-form #socmed-linkedin').val($(this).data(
            'socmedlinkedin'));
        ...
        if ($(this).data('photo')) {
            ...
            $('#nicepage-team #content-team-form #nicepage-team-form #file-photo-upload').removeAttr(
                'required');
        }
