...
<head>
    ...
    <!-- overlayScrollbars -->
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>asset/admin_mu/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
    <!-- Theme style -->
    ...
    <!-- DataTables -->
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>asset/admin_mu/plugins/datatables-bs4/css/dataTables.bootstrap4.css">
    ...
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>asset/admin_mu/plugins/daterangepicker/daterangepicker-bs3.css">
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>asset/admin_mu/plugins/tempusdominus/css/tempusdominus-bootstrap-4.min.css">
    <script type="text/javascript" src="<?php echo base_url(); ?>asset/admin_mu/plugins/daterangepicker/moment.min.js">
    </script>
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            if($this->uri->segment(2)!='home' AND $this->uri->segment(2)!=''){
              ...
              echo "<li class='breadcrumb-item'>Selamat Datang Pt Alumunium AlsuryaAgung</li>";
            }
          ?>
                            </ol>
                        </div><!-- /.col -->
        ...
        <footer class="main-footer text-sm">
            <strong>Copyright &copy; 2014-<?php echo date('Y'); ?> <a target='_BLANK'
                    href="#"><?php echo $iden['nama_website']; ?></a>.</strong>
            All rights reserved.
            <div class="float-right d-none d-sm-inline-block">
                <a style='color:#cecece !important'
                    href="<?php echo base_url().$this->uri->segment(1); ?>/upgrade"><b>Version</b> 3.0.0</a>
            </div>
        </footer>
    </div>
    <!-- ./wrapper -->
    ...
    <script src="<?php echo base_url(); ?>asset/admin_mu/plugins/tempusdominus/js/tempusdominus-bootstrap-4.min.js">
    </script>
    ...
    <!-- overlayScrollbars -->
    <script src="<?php echo base_url(); ?>asset/admin_mu/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js">
    </script>
    <!-- DataTables -->
