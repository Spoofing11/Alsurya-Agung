...
?>
                                    ...
                                    <div class="carousel-caption">
                                        <div class="caption-content-container">
                                            ...
                                            <div class="post-meta">
                                                ...
                                                <?php echo tgl_indo($berita['tanggal']); ?> ,
                                                <i class="fa fa-user"></i> <?php echo "$berita[nama_lengkap]"; ?>,
                                                <a
                                                    href="<?php echo base_url()."kategori/detail/$berita[kategori_seo]"; ?>">
			...
			?>
                            ...
                            <li data-target="#<?php echo $section_id;?>-carousel-slider"
                                data-slide-to="<?php echo $sc;?>" <?php echo ($i == 0 ? 'class="active"' : '');?>></li>
                            <?php } ?>
                        </ol>
                    </div>
                </div>
